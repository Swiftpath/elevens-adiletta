...
public class CardTester {
	...
	public static void main(String[] args) {
		...
		System.out.println("***** six of hearts Tester ********* ");
		...
		System.out.println("  mathcing " + aceClubs1.matches(aceClubs2));
		System.out.println("not mathcing" + aceClubs1.matches(sixHearts));
	}
}
